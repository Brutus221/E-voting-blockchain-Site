...
<div id="container">
    <main>
        <header>
        <div class="icon">
                <p class="logo"> E-Voting Blockchain </p>
                <a href="index.html"><img src="logo4.webp" alt="" width="130px" height="60px"></a> 
              </div>   
            <div class="menu">
             
                <ul>
                    <li><a href="Menu.html">Home</a></li>
                    <li><a href="index.html">Cast_Vote</a></li>
                    <li><a href="Manifestos.html">Manifestos</a></li>
                    <li><a href="http://localhost/Chat_Group/Group_chat.php">Group chat</a></li>
                </ul>
            ...
            <div>
                ...
                <h2>Election Discussion Group</h2> 
            </div>
            <img src="https://s3-us-west-2.amazonaws.com/
            s.cdpn.io/1940306/ico_star.png" alt="">
        </header>
